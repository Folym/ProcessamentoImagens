...
namespace ProcessamentoImagens
{
    class Filtros
    {
        ...
        //sem acesso a memoria
        public static void espelho_diagonal(Bitmap imageBitmapSrc, Bitmap imageBitmapDest)
        {
            int width = imageBitmapSrc.Width;
            int height = imageBitmapSrc.Height;
            ...
            for (int y = 0; y < height; y++)
            {
                ...
                {
                    Color cor = imageBitmapSrc.GetPixel(x, y);
                    imageBitmapDest.SetPixel(width - x - 1, height - y - 1, cor);
                }
            }
        }
        //sem acesso a memoria
        ...
        //com acesso a memoria
        public static void espelho_diagonalDMA(Bitmap imageBitmapSrc, Bitmap imageBitmapDest) 
        {
            int width = imageBitmapSrc.Width;
            int height = imageBitmapSrc.Height;
            int pixelSize = 3;
